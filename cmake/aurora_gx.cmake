...
if (AURORA_ENABLE_DIRECT_VULKAN)
    target_compile_definitions(aurora_gx PRIVATE AURORA_ENABLE_DIRECT_VULKAN)
    if (AURORA_PLATFORM_SWITCH)
        target_compile_definitions(aurora_gx PRIVATE AURORA_USE_DIRECT_VULKAN_GX)
    endif ()
endif ()
